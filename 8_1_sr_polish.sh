...
#run as sr_polish.sh <long_read_assembly.fasta> <short_reads.r1.fastq.gz> <short_reads.r2.fastq.gz> <polished_output.fasta> <threads>
...
polca.sh -a 1_polypolish.fasta -r "$reads1 $reads2" # -t $t -m 2G
